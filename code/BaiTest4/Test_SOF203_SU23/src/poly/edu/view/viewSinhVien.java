...
public class viewSinhVien extends javax.swing.JFrame {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            ...
            if (txtMasv.getText().equalsIgnoreCase("")
                    || txtHoTen.getText().equalsIgnoreCase("")
                    || txtDiemTB.getText().equalsIgnoreCase("")) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ Masv, hoten, diem");
                return;
            }
            if(checkTrungMasv(txtMasv.getText())) {
                JOptionPane.showMessageDialog(this, "Mã SV đã có rồi, không thêm được");
                return;
            }
            //check điểm là số, điểm 0-10            
            try {
            ...
            SinhVien sv = getSinhVienFromInput();
    ...
    private void loadDatatoTable() {
        ArrayList<SinhVien> lst = svs.getAllSinhVien();
        model.setRowCount(0);
        for (SinhVien sv : lst) {
    ...
    private void showDetail() {
        ...
        rdoNam.setSelected(tblSinhVien.getValueAt(index, 2).toString().equalsIgnoreCase("Nam") ? true : false);
        rdoNu.setSelected(!tblSinhVien.getValueAt(index, 2).toString().equalsIgnoreCase("Nam") ? true : false);
    ...
    private SinhVien getSinhVienFromInput() {
        SinhVien sv = new SinhVien();
        sv.setMaSV(txtMasv.getText());
        sv.setHoTen(txtHoTen.getText());
        sv.setGioiTinh(rdoNam.isSelected());
        sv.setNganh((Nganh) modelCombo.getSelectedItem());
        sv.setDiemTB(Double.parseDouble(txtDiemTB.getText()));
        return sv;
    }

    private boolean checkTrungMasv(String masv){
        for (int i = 0; i < tblSinhVien.getRowCount()-1; i++) {
            if(tblSinhVien.getValueAt(i, 0).toString().equalsIgnoreCase(masv)){
                return true;
            }
        }
        return false;
